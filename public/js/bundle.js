...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false // center: latlng,
    // zoom: 4,
    // interactive: true
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "Your ".concat(type.toUpperCase(), " has been updated"));
            }
...
var updateMe = document.querySelector('.form-user-data');
var userPwdForm = document.querySelector('.form-user-password'); // VALUES
// DELEGATION
...
if (updateMe) {
  updateMe.addEventListener('submit', function (e) {
    e.preventDefault();
...
if (userPwdForm) {
  userPwdForm.addEventListener('submit',
  /*#__PURE__*/
  function () {
    var _ref = _asyncToGenerator(
    /*#__PURE__*/
